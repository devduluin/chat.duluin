...
export function GuideProvider({ children }: { children: React.ReactNode }) {
  ...
  const showGuide = React.useCallback((target: HTMLElement, config: GuideConfig) => {
  ...
  const getPositionStyle = (rect: DOMRect, position: GuidePosition = 'bottom') => {
      ...
      <>
        ...
        <div className="fixed inset-0 z-[10] pointer-events-auto">
          ...
          <motion.div
              ...
              className="absolute inset-0 bg-blue-700/30 backdrop-blur-[1px]"
            />
        ...
        >
          {/* Arrow */}
          {config.position && <div style={getArrowStyle(config.position)} />}
